...
class RedBlackTree{
 ...
 private:
  ...
  void traverse_helper(const RBNode*, std::ostringstream&) const;
  void re_root(RBNode*);
  ...
  bool root_p(const RBNode*) const;
  bool leaf_p(const RBNode*) const;
  
  RBNode* grandparent(RBNode*) const;
  RBNode* uncle(RBNode*) const;
  RBNode* sibling(RBNode*) const;
  RBNode* inorder_predecessor(RBNode*) const;
  RBNode* inorder_successor(RBNode*) const;
